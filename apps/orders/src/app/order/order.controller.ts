...
export class OrderController {
  ...
  @MessagePattern(EVENT_MESSAGES.ORDER.CREATE)
  ...
  @MessagePattern(EVENT_MESSAGES.ORDER.FIND_ALL)
  ...
  @MessagePattern(EVENT_MESSAGES.ORDER.FIND_ONE)
  findOne(@Payload('id') id: string) {
    return this.orderService.findOne(id);
  }

  @MessagePattern(EVENT_MESSAGES.ORDER.UPDATE_STATUS)
  ...
  @EventPattern(EVENT_MESSAGES.PAYMENT.SUCCEEDED)
